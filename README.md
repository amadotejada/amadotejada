...
Creator of:
- [Self Portal](https://github.com/amadotejada/self-portal) - a cross-platform desktop application used to deploy software across your endpoint fleet via [Chef](https://github.com/chef).
<!-- <br/> -->
